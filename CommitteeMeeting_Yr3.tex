...
\begin{document}
\noindent \textbf{\Large{Committee Meeting: Summary of Progress (Year 3)}}
\section*{Introduction:}
\begin{enumerate}
\item  \textbf{Rethinking false spring risk}
  \begin{enumerate}
  \item I submitted an Opinion piece to \textit{Global Change Biology} in October 2018 and then resubmitted with revisions to \textit{Global Change Biology} in February 2019. 
  \item \textbf{Abstract:}
...
\item \textbf{Regional effects on false spring risk across Europe in the face of climate change}
  ...
  \item Progress:
    \begin{enumerate}
    \item \textbf{The manuscript is in draft form and is currently being edited by coauthors. The plan is to submit the manuscript to \textit{Global Change Biology} in the next few weeks.}
    \end{enumerate}
  \end{enumerate}
\end{enumerate}
...
\item \textbf{Assessing false spring damage to seedlings coupled with reduced over-winter chilling across species in a temperate forest community}
  ...
  \item Main Hypotheses:
    \begin{enumerate}
    \item Later budburst individuals exposed to false springs will have reduced chlorophyll content and growth
    \item Individuals with reduced chilling - which is expected with climate change - will be less tolerant of false springs (i.e., will have reduced growth and chlorophyll content)
    \end{enumerate}
  \item Main Findings:
    \begin{enumerate}
...
\item \textbf{Assessing budburst and leafout phenology using observations from Harvard Forest, the Arnold Arboretum and a common garden}
  ...
  \item Progress:
    ...
    \item I have written scripts to measure forcing, chilling and photoperiod for each individual for budburst and leafout and have started a literature analysis, with the primary aim to have these available for the Arboretum/Harvard Forest to use once we leave. 
    \end{enumerate}
  \end{enumerate}
\end{enumerate}
...
\begin{itemize}
\item Have worked on a meta-analysis project with the lab since starting the PhD, which will result in at least 3 manuscripts. We are just beginning to write up the manuscripts. 
\item A coordinator for the Arnold Arboretum - Tree Spotters program. I have helped with numerous trainings and events. I also give regular presentations, Tree Mobs and make figures and analyze data for various fundraising/advertising events. 
\item Have offered various courses/lectures at the Arnold Arboretum for both members and non-members with my husband.
