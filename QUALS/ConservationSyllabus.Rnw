...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{center}
\textbf{\LARGE{Conservation \& Global Change Biology}}
\end{center}
...
Additional primary literature or online videos will be available for students to read or watch if they are interested. These optional reading and video assignments will be denoted by an asterisk (*). \\

{\Large{\textbf{SCHEDULE}}}

{\textbf{WEEK 1: Introduction to Conservation}\\
\textbf{Meeting 1:} The History of Conservation Biology
\begin{itemize}
\item CB: 1-26 (\textit{The History and Distinctions of Conservation Biology})
\item \citep{Myers2000} 
\end{itemize}
\-\hspace{2em}{and Conservation: Lessons from History. {\textit{Science, 260(5104),}} 17+36.}\\
