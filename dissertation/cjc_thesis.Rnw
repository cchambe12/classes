...
allcc <- round((aescc+alncc+betcc+fagcc+fracc+quecc)/6, digits=2)
...
allccstand <- round((aesccz+alnccz+betccz+fagccz+fraccz+queccz)/6, digits=2)   #0.16
...
naocc<-round((mean(fixef(long.full, pars="nao.z", summary=FALSE))+mean(fixef(long.full, pars="nao.z:cc.z", summary=FALSE)))/4/((sd(fs$nao)+sd(fs$cc))*2)*100*0.3, digits=2) 
matcc<-round((mean(fixef(long.full, pars="mat.z", summary=FALSE))+mean(fixef(long.full, pars="mat.z:cc.z", summary=FALSE)))/4/((sd(fs$mat)+sd(fs$cc))*2)*100*2, digits=2) 
distcc<-round((mean(fixef(long.full, pars="dist.z", summary=FALSE))+mean(fixef(long.full, pars="dist.z:cc.z", summary=FALSE)))/4/((sd(fs$distkm)+sd(fs$cc))*2)*100*150, digits=2) 
elevcc<-round((mean(fixef(long.full, pars="elev.z", summary=FALSE))+mean(fixef(long.full, pars="elev.z:cc.z", summary=FALSE)))/4/((sd(fs$elev)+sd(fs$cc))*2)*100*200, digits=2)

matccz<-round((mean(fixef(long.full, pars="mat.z:cc.z", summary=FALSE))+mean(fixef(long.full, pars="mat.z", summary=FALSE))), digits=2)
naoccz<-round((mean(fixef(long.full, pars="nao.z:cc.z", summary=FALSE))+mean(fixef(long.full, pars="nao.z", summary=FALSE))), digits=2)
distccz<-round((mean(fixef(long.full, pars="dist.z:cc.z", summary=FALSE))+mean(fixef(long.full, pars="dist.z", summary=FALSE))), digits=2)
elevccz<-round((mean(fixef(long.full, pars="elev.z:cc.z", summary=FALSE))+mean(fixef(long.full, pars="elev.z", summary=FALSE))), digits=2)
...
matdvrz<-round((mean(fixef(dvrlong.full, pars="mat.z", summary=FALSE))), digits=2)
naodvrz<-round((mean(fixef(dvrlong.full, pars="nao.z", summary=FALSE))), digits=2)
distdvrz<-round((mean(fixef(dvrlong.full, pars="dist.z", summary=FALSE))), digits=2)
elevdvrz<-round((mean(fixef(dvrlong.full, pars="elev.z", summary=FALSE))), digits=2)
...
matdvrccz<-round((mean(fixef(dvrlong.full, pars="mat.z:cc.z", summary=FALSE))+mean(fixef(long.full, pars="mat.z", summary=FALSE))), digits=2)
naodvrccz<-round((mean(fixef(dvrlong.full, pars="nao.z:cc.z", summary=FALSE))+mean(fixef(long.full, pars="nao.z", summary=FALSE))), digits=2)
distdvrccz<-round((mean(fixef(dvrlong.full, pars="dist.z:cc.z", summary=FALSE))+mean(fixef(long.full, pars="dist.z", summary=FALSE))), digits=2)
elevdvrccz<-round((mean(fixef(dvrlong.full, pars="elev.z:cc.z", summary=FALSE))+mean(fixef(long.full, pars="elev.z", summary=FALSE))), digits=2)


### Same rule but for Five model:
matfive<-round((mean(fixef(fivelong.full, pars="mat.z", summary=FALSE))/4)/(sd(fsfive$mst)*2)*100*2, digits=2) ## -11.56
naofive<-round((mean(fixef(fivelong.full, pars="nao.z", summary=FALSE))/4)/(sd(fsfive$nao)*2)*100*0.3, digits=2) ## 1.26
distfive<-round((mean(fixef(fivelong.full, pars="dist.z", summary=FALSE))/4)/(sd(fsfive$distkm)*2)*100*150, digits=2) ## 2.75
elevfive<-round((mean(fixef(fivelong.full, pars="elev.z", summary=FALSE))/4)/(sd(fsfive$elev)*2)*100*200, digits=2) ## 7.35
ccfive<-round((mean(fixef(fivelong.full, pars="cc.z", summary=FALSE))/4)/(sd(fsfive$cc)*2)*100, digits=2) ## 14.55

aesccfive<-round((mean(fixef(fivelong.full, pars="cc.z", summary=FALSE))/4)/(sd(fsfive$cc)*2)*100,digits=2) 

alnccfive<-round(((mean(fixef(fivelong.full, pars="cc.z", summary=FALSE))+ mean(fixef(fivelong.full, pars="cc.z:speciesALNGLU", summary=FALSE)))/4)/(sd(fsfive$cc)*2)*100, digits=2) 

betccfive<-round(((mean(fixef(fivelong.full, pars="cc.z", summary=FALSE))+ mean(fixef(fivelong.full, pars="cc.z:speciesBETPEN", summary=FALSE)))/4)/(sd(fsfive$cc)*2)*100, digits=2) 

fagccfive<-round(((mean(fixef(fivelong.full, pars="cc.z", summary=FALSE))+ mean(fixef(fivelong.full, pars="cc.z:speciesFAGSYL", summary=FALSE)))/4)/(sd(fsfive$cc)*2)*100, digits=2)

fraccfive<-round(((mean(fixef(fivelong.full, pars="cc.z", summary=FALSE))+ mean(fixef(fivelong.full, pars="cc.z:speciesFRAEXC", summary=FALSE)))/4)/(sd(fsfive$cc)*2)*100, digits=2)

queccfive<-round(((mean(fixef(fivelong.full, pars="cc.z", summary=FALSE))+ mean(fixef(fivelong.full, pars="cc.z:speciesQUEROB", summary=FALSE)))/4)/(sd(fsfive$cc)*2)*100, digits=2)

allfivecc <- round((aesccfive+alnccfive+betccfive+fagccfive+fraccfive+queccfive)/6, digits=2)

aescczfive <- round((mean(fixef(fivelong.full, pars="cc.z", summary=FALSE))), digits=2)
alncczfive <- round((mean(fixef(fivelong.full, pars="cc.z", summary=FALSE))+mean(fixef(fivelong.full, pars="cc.z:speciesALNGLU", summary=FALSE))), digits=2)
betcczfive <- round((mean(fixef(fivelong.full, pars="cc.z", summary=FALSE))+mean(fixef(fivelong.full, pars="cc.z:speciesBETPEN", summary=FALSE))), digits=2)
fagcczfive <- round((mean(fixef(fivelong.full, pars="cc.z", summary=FALSE))+mean(fixef(fivelong.full, pars="cc.z:speciesFAGSYL", summary=FALSE))), digits=3)
fracczfive <- round((mean(fixef(fivelong.full, pars="cc.z", summary=FALSE))+mean(fixef(fivelong.full, pars="cc.z:speciesFRAEXC", summary=FALSE))), digits=2)
quecczfive <- round((mean(fixef(fivelong.full, pars="cc.z", summary=FALSE))+mean(fixef(fivelong.full, pars="cc.z:speciesQUEROB", summary=FALSE))), digits=2)

allfiveccstand <- round((aescczfive+alncczfive+betcczfive+fagcczfive+fracczfive+quecczfive)/6, digits=2)   #0.16


matfivez<-round((mean(fixef(fivelong.full, pars="mat.z", summary=FALSE))), digits=2)
naofivez<-round((mean(fixef(fivelong.full, pars="nao.z", summary=FALSE))), digits=2)
distfivez<-round((mean(fixef(fivelong.full, pars="dist.z", summary=FALSE))), digits=2)
elevfivez<-round((mean(fixef(fivelong.full, pars="elev.z", summary=FALSE))), digits=2)

### Okay now, we can calculate the interaction effects:
naoccfive<-round((mean(fixef(fivelong.full, pars="nao.z", summary=FALSE))+mean(fixef(fivelong.full, pars="nao.z:cc.z", summary=FALSE))/4)/(sd(fsfive$nao)*2)*100*0.3, digits=2) 
matccfive<-round((mean(fixef(fivelong.full, pars="mat.z", summary=FALSE))+mean(fixef(fivelong.full, pars="mat.z:cc.z", summary=FALSE))/4)/(sd(fsfive$mat)*2)*100*2, digits=2)
distccfive<-round((mean(fixef(fivelong.full, pars="dist.z", summary=FALSE))+mean(fixef(fivelong.full, pars="dist.z:cc.z", summary=FALSE))/4)/(sd(fsfive$distkm)*2)*100*150, digits=2)
elevccfive<-round((mean(fixef(fivelong.full, pars="elev.z", summary=FALSE))+mean(fixef(fivelong.full, pars="elev.z:cc.z", summary=FALSE))/4)/(sd(fsfive$elev)*2)*100*200, digits=2)

matfiveccz<-round((mean(fixef(fivelong.full, pars="mat.z:cc.z", summary=FALSE))+mean(fixef(long.full, pars="mat.z", summary=FALSE))), digits=2)
naofiveccz<-round((mean(fixef(fivelong.full, pars="nao.z:cc.z", summary=FALSE))+mean(fixef(long.full, pars="nao.z", summary=FALSE))), digits=2)
distfiveccz<-round((mean(fixef(fivelong.full, pars="dist.z:cc.z", summary=FALSE))+mean(fixef(long.full, pars="dist.z", summary=FALSE))), digits=2)
elevfiveccz<-round((mean(fixef(fivelong.full, pars="elev.z:cc.z", summary=FALSE))+mean(fixef(long.full, pars="elev.z", summary=FALSE))), digits=2)
...
aescctemps<-round((mean(fixef(longtemps.full, pars="cc.z", summary=FALSE))/4)/(sd(fstemps$cc)*2)*100,digits=2) 

alncctemps<-round(((mean(fixef(longtemps.full, pars="cc.z", summary=FALSE))+ mean(fixef(longtemps.full, pars="cc.z:speciesALNGLU", summary=FALSE)))/4)/(sd(fstemps$cc)*2)*100, digits=2) 

betcctemps<-round(((mean(fixef(longtemps.full, pars="cc.z", summary=FALSE))+ mean(fixef(longtemps.full, pars="cc.z:speciesBETPEN", summary=FALSE)))/4)/(sd(fstemps$cc)*2)*100, digits=2) 

fagcctemps<-round(((mean(fixef(longtemps.full, pars="cc.z", summary=FALSE))+ mean(fixef(longtemps.full, pars="cc.z:speciesFAGSYL", summary=FALSE)))/4)/(sd(fstemps$cc)*2)*100, digits=2)

fracctemps<-round(((mean(fixef(longtemps.full, pars="cc.z", summary=FALSE))+ mean(fixef(longtemps.full, pars="cc.z:speciesFRAEXC", summary=FALSE)))/4)/(sd(fstemps$cc)*2)*100, digits=2)

quecctemps<-round(((mean(fixef(longtemps.full, pars="cc.z", summary=FALSE))+ mean(fixef(longtemps.full, pars="cc.z:speciesQUEROB", summary=FALSE)))/4)/(sd(fstemps$cc)*2)*100, digits=2)

alltempscc <- round((aescctemps+alncctemps+betcctemps+fagcctemps+fracctemps+quecctemps)/6, digits=2)

aesccztemps <- round((mean(fixef(longtemps.full, pars="cc.z", summary=FALSE))), digits=2)
alnccztemps <- round((mean(fixef(longtemps.full, pars="cc.z", summary=FALSE))+mean(fixef(longtemps.full, pars="cc.z:speciesALNGLU", summary=FALSE))), digits=2)
betccztemps <- round((mean(fixef(longtemps.full, pars="cc.z", summary=FALSE))+mean(fixef(longtemps.full, pars="cc.z:speciesBETPEN", summary=FALSE))), digits=2)
fagccztemps <- round((mean(fixef(longtemps.full, pars="cc.z", summary=FALSE))+mean(fixef(longtemps.full, pars="cc.z:speciesFAGSYL", summary=FALSE))), digits=3)
fraccztemps <- round((mean(fixef(longtemps.full, pars="cc.z", summary=FALSE))+mean(fixef(longtemps.full, pars="cc.z:speciesFRAEXC", summary=FALSE))), digits=2)
queccztemps <- round((mean(fixef(longtemps.full, pars="cc.z", summary=FALSE))+mean(fixef(longtemps.full, pars="cc.z:speciesQUEROB", summary=FALSE))), digits=2)

alltempsccstand <- round((aesccztemps+alnccztemps+betccztemps+fagccztemps+fraccztemps+queccztemps)/6, digits=2)   #0.16
...
disttempsccz<-round((mean(fixef(longtemps.full, pars="dist.z:cc.z", summary=FALSE))+mean(fixef(long.full, pars="dist.z", summary=FALSE))), digits=2)
elevtempsccz<-round((mean(fixef(longtemps.full, pars="elev.z:cc.z", summary=FALSE))+mean(fixef(long.full, pars="elev.z", summary=FALSE))), digits=2)
...
simpfsdf <- as.data.frame(fixef(fstotlong.mod, pars=c("cc", "cc:speciesALNGLU", "cc:speciesBETPEN", "cc:speciesFAGSYL", "cc:speciesFRAEXC", "cc:speciesQUEROB")))
simpfsdf$parameter <- rownames(simpfsdf)

simpfsdf$Estimate <- ifelse(simpfsdf$parameter=="cc", simpfsdf$Estimate, simpfsdf$Estimate + simpfsdf$Estimate[simpfsdf$parameter=="cc"])
simpfs <- round(mean(simpfsdf$Estimate), digits=2)
simpfssd <- round(sd(simpfsdf$Estimate), digits=2)
...
After climate change, the effects of these climatic and geographic factors on false spring risk shifted (Figure \ref{fig:maineffects}). With climate change, the effect of mean spring temperature on false spring risk remained consistent, where warmer sites still tended to have lower risks of false springs \Sexpr{matcc}\% in risk per 2$^{\circ}$C (or \Sexpr{matccz} $\pm$ 0.06 probability of false spring/standard unit versus \Sexpr{mat}\% per 2$^{\circ}$C or \Sexpr{matz} before climate change; Figure \ref{fig:maineffects} and Figure \ref{fig:suppapc}\textbf{a}). The level of risk also remained consistent before and after 1983 at sites further from the coast (Figure \ref{fig:maineffects} and Figure \ref{fig:suppapc}\textbf{b}). With warming, there was a large reduction in risk in false springs at higher elevations (Figure \ref{fig:maineffects} and Figure \ref{fig:suppapc}\textbf{c}), with \Sexpr{elevcc}\% increase in risk per 150km (or \Sexpr{elevccz} $\pm$ 0.06 probability of risk/standard unit versus \Sexpr{elev}\% increase 150km or \Sexpr{elevz} $\pm$ 0.08 before climate change). The rate of false spring incidence largely decreased after climate change with increasing NAO indices (Figure \ref{fig:maineffects} and Figure \ref{fig:suppapc}\textbf{d}), with a \Sexpr{naocc}\% in risk per 0.3 unit increase in the NAO index (or \Sexpr{naoccz} $\pm$0.06 probability of false spring/standard unit or versus \Sexpr{nao}\% per 0.3 unit increase in the NAO index or \Sexpr{naoz} $\pm$ 0.06 before climate change). After climate change, NAO had the strongest effect on false spring risk, with higher NAO indices rendering fewer false springs.

Overall, there was little change in false spring risk across all species (\Sexpr{allcc}\% or \Sexpr{allccstand} in probability of risk/standard unit), due to climate change (after 1983) that was not otherwise explained the climatic and geographic factors we examined. This effect, however, varied by species, with an \Sexpr{aescc}\% increased risk in false springs after climate change for \textit{Aesculus hippocastanum} (or \Sexpr{aesccz} $\pm$ 0.06 probability of false spring/standard unit; Figure \ref{fig:maineffects}, Figure \ref{fig:spp}\textbf{d} and Table \ref{tab:suppmodlong}), a \Sexpr{alncc}\% increase for \textit{Alnus glutinosa}, and a \Sexpr{betcc}\% increase for \textit{Betula pendula} (or a \Sexpr{alnccz} $\pm$ 0.09 and \Sexpr{betccz} $\pm$ 0.07 probability of false spring/standard unit respectively; Figure \ref{fig:maineffects}, Figure \ref{fig:spp}\textbf{e} and Table \ref{tab:suppmodlong}). Climate change decreased risk by \Sexpr{fagcc}\% for \textit{Fagus sylvatica}, \textit{Fraxinus excelsior} by \Sexpr{fracc}\% and \textit{Quercus robur} by \Sexpr{quecc}\% (or \Sexpr{fagccz} $\pm$ 0.09, \Sexpr{fraccz} $\pm$ 0.11 and \Sexpr{queccz} $\pm$ 0.09 probability of false spring/standard unit respectively; Figure \ref{fig:maineffects}, Figure \ref{fig:spp}\textbf{e} and Table \ref{tab:suppmodlong}).  

\subsection*{Sensitivity of results to duration of risk and temperature thresholds}
Our results remained consistent (in direction and magnitude) when we applied different rates of leafout for each species (i.e., varied the length of time between estimated budburst and leafout). Mean spring temperature (\Sexpr{matdvr}\% for every 2$^\circ$C or \Sexpr{matdvrz} $\pm$ 0.06 probability of risk/standard unit), distance from the coast (\Sexpr{distdvr}\% increase for every 150km or \Sexpr{distdvrz} $\pm$ 0.07 probability of risk/standard unit), elevation (\Sexpr{elevdvr}\% increase for every 200m or \Sexpr{elevdvrz} $\pm$ 0.07 probability of risk/standard unit) and NAO (\Sexpr{naodvr}\% increase for every 0.3 or \Sexpr{naodvrz} $\pm$ 0.05 probability of risk/standard unit) all contributed to false spring risk (Figure \ref{fig:dvr} and Table \ref{tab:suppmoddvr}). After climate change, results also were congruous with our main findings (Figure \ref{fig:dvr}, Table \ref{tab:suppmoddvr} and Figure \ref{fig:sppdvr}).  

Results also remained generally consistent when we applied a lower temperature threshold for defining a false spring (i.e., -5$^{\circ}$C), though there were more shifts in the magnitude of some effects, especially those of climate change. Mean spring temperature (\Sexpr{matfive}\% for every 2$^\circ$C or \Sexpr{matfivez} $\pm$ 0.12 probability of risk/standard unit) was the strongest predictor but distance from the coast (\Sexpr{distfive}\% increase in risk for every 150km or \Sexpr{distfivez} $\pm$ 0.13 probability of risk/standard unit), elevation (\Sexpr{elevfive}\% increase in risk for every 200m or \Sexpr{elevfivez} $\pm$ 0.14 probability of risk/standard unit) and NAO (\Sexpr{naofive}\% increase in risk for every 0.3 or \Sexpr{naofivez} $\pm$ 0.12 probability of risk/standard unit) all contributed to risk of false spring. There was greater increase in false spring risk due to the residual climate change effect across all six species combined, though the greatest increase was in the early-leafout species (\Sexpr{allfivecc}\% increase or \Sexpr{allfiveccstand} $\pm$ 0.11 probability of risk/standard unit; Figure \ref{fig:five}, Table \ref{tab:suppmodfive} and Figure \ref{fig:sppfive}). 

Results of climatic and geographic effects, again, remained consistent in our varying threshold model (where we defined a false spring as -5$^{\circ}$C for early-leafout species and -2.2$^{\circ}$C for late-leafout species) with all predictors contributing to risk: mean spring temperature (\Sexpr{mattemps}\% for every 2$^\circ$ or \Sexpr{mattempsz} $\pm$ 0.13 probability of risk/standard unit), distance from the coast (\Sexpr{disttemps}\% for every 2$^\circ$C or \Sexpr{disttempsz} $\pm$ 0.14 probability of risk/standard unit), elevation (\Sexpr{elevtemps}\% for every 200m or \Sexpr{elevtempsz} $\pm$ 0.14 probability of risk/standard unit) and NAO (\Sexpr{naotemps}\% for every 2$^\circ$ or \Sexpr{naotempsz} $\pm$ 0.12 probability of risk/standard unit). There was also a slight increase in false spring risk due to the residual effect of climate change across all six species (\Sexpr{alltempscc}\% increase or \Sexpr{alltempsccstand} $\pm$ 0.06 probability of risk/standard unit; Figure \ref{fig:longtemps} and Table \ref{tab:suppmodlongtemps}). In contrast to our other models, in this model late-leafout species (i.e., \textit{Fagus sylvatica}, \textit{Quercus robur}, \textit{Fraxinus excelsior}) experienced more false springs than the early-leafout species (i.e., \textit{Aesculus hippocastanum}, \textit{Alnus glutinosa}, \textit{Betula pendula}), though after climate change all species experienced a more similar magnitude of risk (Figure \ref{fig:spptemps}). 

\section*{Discussion} % 1815 words
Integrating over \Sexpr{numyrs} years of data, \Sexpr{numsites} sites across Central Europe and major climatic and geographic factors, our results suggest climate change has reshaped the factors that drive false spring risk. Our results support that higher elevations tend to experience more false springs \citep{Vitra2017,Vitasse2018} and sites that are generally warmer have lower risks of false springs \citep{Wypych2016}. Individuals further from the coast typically initiated leafout earlier in the season, which subsequently increased risk and, similarly, years with higher NAO indices experienced an increase in risk. 
