...
{\begin{figure}[h]
    ...
    \label{fig:damage}
\end{figure}}
Plant phenology -- which is defined as the timing of life-history events such as budburst -- strongly tracks shifts in climate \citep{Wolkovich2012}. With climate change advancing, there is already evidence of many species initiating leafout 4-6 days earlier per $^{\circ}$C of warming \citep{Wolkovich2012}. However, last spring freeze dates are not predicted to advance at the same rate as spring onset \citep{Labe2016}, potentially amplifying the effects of false spring events in certain regions.
