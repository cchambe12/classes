...
{\begin{figure} [H]
  -\begin{center}
  -\includegraphics[width=9cm]{chloro_effects.pdf}
  -\caption{The parameter effects of false spring events on leaf chlorophyll content. The combined effect of species and treatment decrease the chlorophyll content of leaves by 2.1, thus potentially reducing the photosynthetic capacity of leaves exposed to false spring events.}\label{fig:chloro}
  -\end{center}
  -\end{figure}}
...
\\
\textit{I will design a field experiment to evaluate the differences in damage sustained across life stage to assess forest recruitment and sustainability.} Plants suffer long-term effects from the loss of photosynthetic, which could impact multiple years of growth, reproduction, and canopy development \citep{Sakai1987, Vitasse2014} and it could vary by life stage. Various studies have studied the effects of spring freezes on temperate trees in controlled environments \citep{Lenz2013, Lenz2016, Caradonna2016} or after reported false spring events \citep{Gu2008, Augspurger2009} however, few have investigated the effects of false springs \textit{in situ} using portable growth chambers. I will monitor the phenology of sapling and adult individuals across 8-10 species for 16-24 individuals per species and expose half of the individuals to simulated false spring events (Table \ref{tab:fieldfrz}).  To simulate a false spring, I will construct multiple in-field growth chambers and place them over individuals between budburst and leafout for several hours at night. I will then monitor their growth and phenology for many field seasons to determine the long-term effects of spring freezes across life stage. The objective of this chapter is to  understand the effects of false springs on forest recruitment and the long-term effects on photosynthetic tissues of false springs. 
...
\\
\textit{I will analyze large-scale effects across space and time to inspect the effects of climatic shifts on range distributions of native species.} The climatic implications of advancing forcing temperatures could potentially lead to earlier dates of budburst and enhance the risk of frost. These shifts in climatic regimes could vary in intensity across regions (i.e. habitats currently at risk of false spring damage could become low risk regions over time). Thus, it is crucial to gain an understanding on which climatic parameters result in false spring events and how these parameters may vary across regions. I will assess gridded climate data first across Europe, and then ultimately across the US, from 1950-2016. I will then integrate long-term phenological data for 8-12 species and determine the number of false spring events that each species experiences and if that varies by region and over time, with the intention to delineate large-scale spatial patterns in false spring risk in a changing climate. 

\textbf{Preliminary Results:}\\
There is large debate over whether or not spring freeze damage will increase \citep{Hannenin1991, Augspurger2013, Labe2016}, remain the same \citep{Scheifinger2003} or even decrease \citep{Kramer1994} with climate change. I assessed the daily gridded climate data across Europe (E-OBS) from 1950-2016. By simply using climate data, I compared the frequency of false spring events before and after climate change across Europe. A false spring was considered if the the daily minimum temperature fell below -2$^{\circ}$C \citep{Schwartz1993} between March 1 and June 30. Certain regions experienced increased exposure to false spring events, whereas other regions experienced fewer or similar numbers of false spring years (Figure \ref{fig:region}).

{\begin{figure} [H]
  -\begin{center}
  -\includegraphics[width=12cm]{FS_Diff.pdf}
  -\caption{Number of false spring years that occured before climate change (1951-1983) as compared to after climate change (1984-2016). If temperatures fell below -2$^{\circ}$C between March 1 and June 30, a false spring year was tallied. Some regions experienced more false spring years after climate change, whereas other years experienced the same number or even fewer false spring years.}\label{fig:region}
  -\end{center}
  -\end{figure}}
  

\textbf{\large{Future Studies: }}\\
\\
